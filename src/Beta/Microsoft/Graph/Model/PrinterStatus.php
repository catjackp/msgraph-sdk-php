    ...
    */
    public function getDetails()
    {
        if (array_key_exists("details", $this->_propDict) && !is_null($this->_propDict["details"])) {
            ...
            if(count($this->_propDict['details']) === 0){
              return $this->_propDict['details'];
            }
            if (is_a($this->_propDict['details'][0], ' PrinterProcessingStateDetail')) {
               return $this->_propDict['details'];
            }
            $details = [];
    ...
    */
    public function getProcessingStateReasons()
    {
        if (array_key_exists("processingStateReasons", $this->_propDict) && !is_null($this->_propDict["processingStateReasons"])) {
            ...
            if(count($this->_propDict['processingStateReasons']) === 0){
              return $this->_propDict['processingStateReasons'];
            }
            if (is_a($this->_propDict['processingStateReasons'][0], ' PrinterProcessingStateReason')) {
               return $this->_propDict['processingStateReasons'];
            }
